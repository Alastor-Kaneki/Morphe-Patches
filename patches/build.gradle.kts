...
patches {
    about {
        ...
        description = "Morphe patches for a standalone Opera GX launcher icon selector, Opera GX raw mod downloads, and a cloneable Chrome Android Material You userscript manager with a Violentmonkey-derived parser and Greasy Fork/Sleazy Fork support."
